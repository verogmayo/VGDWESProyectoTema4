...
<head>
    ...
    <title>Véro Grué - ProyectoTema4 CargaDBVGDWESProyectoTema4</title>
    <link rel="stylesheet" href="../webroot/css/styleEjercicios.css">
</head>
<body>
    <header class="header">
         <a href="../indexProyectoTema4.php">volver</a>
        <h1>Muestra CargaDBVGDWESProyectoTema4</h1>
    </header>
    <main>
        <section>
            <?php 
     highlight_file('../scriptDB/CargaDBVGDWESProyectoTema4.sql');
    ?>
        </section>
